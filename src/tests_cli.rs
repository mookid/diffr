...
fn color_invalid_attribute_name() {
    test_cli(ProcessTest {
        ...
        out: Empty,
        err: Exactly("unexpected attribute name: got 'bar', expected foreground|background|italic|noitalic|bold|nobold|dimmed|nodimmed|intense|nointense|underline|nounderline|none"),
        is_success: false,
    })
}
